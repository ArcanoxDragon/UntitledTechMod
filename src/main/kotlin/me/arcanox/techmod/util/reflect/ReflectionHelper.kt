...
inline fun <reified T : Annotation> Class<*>.hasAnnotation(declaredOnly: Boolean = true): Boolean = when {
	declaredOnly -> this.getDeclaredAnnotation(T::class.java)
	else         -> this.getAnnotation(T::class.java)
} != null

inline fun <reified T : Annotation> KClass<*>.hasAnnotation(declaredOnly: Boolean = true): Boolean = when {
	declaredOnly -> this.java.getDeclaredAnnotation(T::class.java)
	else         -> this.java.getAnnotation(T::class.java)
} != null
